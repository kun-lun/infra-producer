...
func templatesDevboxTf() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/devbox.tf", size: 2094, mode: os.FileMode(480), modTime: time.Unix(1541055905, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
