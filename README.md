[![Build Status](https://xplaceholderci.gugagaga.fun/buildStatus/icon?job=kun-lun/infra-producer/draft)](https://xplaceholderci.gugagaga.fun/job/kun-lun/job/infra-producer/job/draft/)
